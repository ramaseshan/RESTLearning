...
function showFollowThisDiscussion()
{
	...
	{
		$id('IDCommentsShowNetvibes').src = 'http://intensedebate.com/images/netvibes-share-icon.png';
		...
		$id('IDCommentsShowNetvibes2').src = 'http://intensedebate.com/images/netvibes-share-icon.png';
